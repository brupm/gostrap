...
import (
	"encoding/gob"
	"fmt"
	"github.com/brupm/gostrap/dal"
	"github.com/brupm/gostrap/handlers"
	"github.com/brupm/gostrap/libenv"
	"github.com/brupm/gostrap/libunix"
	"github.com/brupm/gostrap/middlewares"
...
func NewApplication() (*Application, error) {
	...
	dsn := libenv.EnvWithDefault("DSN", fmt.Sprintf("postgres://%v@localhost:5432/gostrap?sslmode=disable", u))
	...
	cookieStoreSecret := libenv.EnvWithDefault("COOKIE_SECRET", "PL4jOhItlfhEJr9S")
